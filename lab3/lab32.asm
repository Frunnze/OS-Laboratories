...
execute_command:
    ...
    elif_m:
        ...
        ; computing the nr of sectors
        mov ax, [Q]     ; size of the data block
        mov bx, 512     ; Size of a sector
        xor dx, dx      ; dx will contain the result of the division
        div bx          ; ax = ax / bx
        mov cl, dl      ; cl contains the number of sectors
...
read_from_floppy:
    ...
    ret
write_ram_floppy:
    mov ah, 03h; command to write sectors 
    mov al, 0
    mov dl, 0 ; driver
    int 13h ; execute the command
clear_buffer:
